...
public class MaquinaBebidas {
	...
	//Precio de las bebidas(comï¿½n para	todas)
	...
	/* Responder a una acciï¿½n del usuario. Discrimina el tipo de
	accion */
	...
	/* Realiza las acciones relacionadas con la selecciï¿½n de una
	bebida */
	/* Entradas: char o, la orden del usuario */
	/* Salidas: Ninguna */
